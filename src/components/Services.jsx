        ...
        {services.map((service, index) => (
          index % 2 === 0 ? (
            ...
            <div key={index} className='relative md:ml-[50%]'>
              <div className='relative md:h-[380px] md:w-[86%] md:shadow-lg md:shadow-black'>
                <img src={service.image.url} alt={service.name} className='w-full h-full object-cover' />
                <div className='faded-service-1 absolute top-0 h-full left-0 w-full'></div>
              </div>
              <div className='md:absolute md:p-0 p-4 md:bg-transparent bg-[#0c0c1d] md:top-[12%] md:-left-[74%] md:w-[550px] flex flex-col '>
