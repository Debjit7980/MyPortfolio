  ...
  return (
    <div className='bg-[#111132] h-auto pt-[120px] pb-[40px]  w-full'>
      <div className='text-[42px] pt-20 pb-20  relative'>
        ...
        <div className='md:absolute md:top-[50%] md:left-[25%] ml-[4%] md:ml-0 border-t border-gray-600 md:w-[18%] w-[45%] '></div>
      </div>
      <div className='w-[92%]  mx-auto h-auto relative flex flex-col md:gap-[180px] gap-[120px]   z-0 '>
        {services.map((service, index) => (
          index % 2 === 0 ? (
            <div key={index} className='relative shadow-lg shadow-black md:shadow-none'>
              <div className='relative md:h-[350px] md:w-[54%] md:shadow-lg md:shadow-black'>
              ...
              <div className='md:absolute md:p-0 p-4 md:top-[12%] md:left-[52%] md:bg-transparent bg-[#0c0c1d]  left-0 md:w-[550px] flex flex-col '>
            ...
            <div key={index} className='relative md:w-[54%] md:ml-auto'>
              ...
              <div className='md:absolute md:p-0 p-4 md:bg-transparent bg-[#0c0c1d] md:top-[12%] md:-ml-[62%] md:w-[550px] flex flex-col '>
